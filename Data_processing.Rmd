...
In order to assess whether clustering of certain cell types would reduce the complexity of the deconvolution, the 21 cell types will be reduced to ...
...
test <- as.data.frame(cell.state.labels)
test2 <- as.data.frame(cell.type.labels)
