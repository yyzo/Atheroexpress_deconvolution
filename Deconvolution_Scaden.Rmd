...
do
  ...
  scaden simulate --data output/scaden_format_files/ -n 800 --pattern "*_counts.txt" --out output/plaque_b700_$i
  
  scaden process output/plaque_b700_$i/scaden.h5ad output/scaden_format_files/scaden_bulk_data.txt --processed_path output/plaque_b700_$i/processed.h5ad
  
  mkdir models/model_plaque_b700_$i
  
  scaden train output/plaque_b700_$i/processed.h5ad --steps 5000 --model_dir models/model_plaque_b700_$i
