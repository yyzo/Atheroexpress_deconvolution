...
```{r}
# sum(is.na(predSympWide$DM.composite))

contCol <- c("BMI", "GFR_MDRD") # MODIFY HERE
binCol <- c("SmokerCurrent", "PAOD", "CAD_history", "Med.statin.derived", "Med.Statin.LLD", "CI_history", "Calc.bin") # For Symptoms.2g and MACE
...
responseVar <- "Calc.bin" # MODIFY HERE
covariates <- c("batch") # MODIFY HERE; for interaction terms, add together in one string ("var1 * var2")
...
covariates <- c("batch", "DM.composite", "Hypertension.composite", "SmokerCurrent") # MODIFY HERE
