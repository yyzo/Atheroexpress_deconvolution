...
**Note**: Users can adapt the code in chunks or lines marked with `# MODIFY HERE`.
...
# Import the target bulk RNA-seq dataset. Below are datasets used in this project. Information on the data collection can be found in the GitHub repository.
...
if(exists("bulkCombineCorrected")) {
  saveRDS(bulkCombineCorrected, "data/preprocessed_data/bAEccfRNACombine_v2.rds") # Corrected for batches
